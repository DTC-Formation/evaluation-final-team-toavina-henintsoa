	...
	<div class="container-fluid " id="home">
				...
				<div class="row">
					<div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-xs-12  text-center">
						<h1 id="welcome"> Tongasoa </h1>
						<p>
							Lisitry ny fokontany rehetra mandrafitra an'i Madagasikara voasokajy arak'ireo Distrika sy Faritra ary Faritany misy azy avy.
						</p>
					</div>
				</div>
		<!-- Barre de recherche-->
			<div class="row">
				<div class="col-lg-4 col-md-4 col-xs-6 offset-lg-4 offset-md-4">
					<div class="input-group mb-3">
					   <input type="text" class="form-control " placeholder="Fokontany / Distrika/Faritra/Faritany">
